...
<div class="content">
  ...
  //! Select Nama Ketua
  $selectNamaKetua   = "SELECT * FROM ketua_anggota WHERE id_ketua_anggota = '$ketua' ";
  $queryNamaKetua    = mysqli_query($host, $selectNamaKetua); 
  $dataKetua         = mysqli_fetch_assoc($queryNamaKetua);
  $namaKetua         = $dataKetua['nama_lengkap'];
  ?>
  <h3>Form Anggota Dari Ketua : <?= $namaKetua ?> </h3>
